    ...
    return (
        ...
        <div className="grid grid-cols-3 w-full">
            <div className="flex flex-col gap-4">
                <div className="text-indigo-700 text-[20px]" >Java Script</div>
            ...
            <div className="flex flex-col gap-4">
                <div className="text-indigo-700 text-[20px]" >React.Js</div>
                <p className="text-[12px] text-gray-900">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin volutpat justo enim. Suspendisse ut odio tempus, fermentum ante ac, tempus eros. 
            ...
            <div className="flex flex-col gap-4">
                <div className="text-indigo-700 text-[20px]" >Node.Js</div>
                <p className="text-[12px] text-gray-900">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin volutpat justo enim. Suspendisse ut odio tempus, fermentum ante ac, tempus eros.                
                </p>
            </div>
