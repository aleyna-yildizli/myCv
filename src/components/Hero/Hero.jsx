    ...
    <div className="flex flex-col  w-full xl:mt-14 lg:mt-8 md:mt-5 mt-2 ">
      <div className="flex ">
        <div className="flex flex-col xl:gap-[50px] lg:gap-[20px] md:gap-[10px] gap-[5px] relative">
          ...
          {presentation && (
            <h1 className="xl:text-6xl lg:text-4xl md:text-2xl text-xl font-bold text-[#1F2937] dark:text-[#AEBCCF]">
              {presentation}
            </h1>
          )}
          {introduction && (
        ...
        <div className="hero_image_card w-full h-full relative ">
          {image && (
            <img
              className="hero_image xl:w-[476px] xl:h-[375px] lg:w-[426px] lg:h-[335px] md:lg:w-[426px] md:h-[335px] display-none object-cover rounded-[18px] absolute right-0"
              src={`${image}`}
              alt=""
            />
          )}
