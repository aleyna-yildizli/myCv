    ...
    <div className="flex items-center justify-between w-full">
      ...
      <nav>
        <ul className="flex items-center xl:gap-16 lg:gap-4 md:gap-2 gap-1 xl:text-lg lg:text-base md:text-sm text-[10px] leading-7 font-medium text-gray-600">
          ...
          <li className="cursor-pointer border border-[#3730A3] text-[#3730A3] bg-white px-1 py-0.3 sm:px-2 sm:py-1 md:px-4 md:py-2 lg:px-4 lg:py-2 xl:px-4 xl:py-2 rounded outline-none hover:scale-105">
