            ...
            <div className="flex ">
                <div className="flex flex-col xl:gap-[50px] lg:gap-[20px] md:gap-[10px] gap-[5px] relative">
                    <div className="flex items-center xl:gap-3 gap-1 ">
                        ...
                        {name && (
                        <div className="xl:text-[20px] lg:text-[18px] md:text-[16px] text-[14px]  font-medium text-[#4338CA] dark:text-[#B7AAFF]">{name}</div>
                        )}
                    </div>
                    {presentation && (
                ...
                <div className="flex items-center xl:gap-3 md:gap-2 gap-1 bottom-1 left-0 font-semibold">
                    <Link className=" bg-indigo-800 text-white xl:px-8 xl:py-2 lg:px-5 lg:py-1 px-4 py-1 rounded dark:text-black dark:bg-[#E1E1FF]" to="/">Hire me</Link>
                    <Link className="flex items-center gap-2  xl:px-5 xl:py-2 px-2 py-1 rounded border border-indigo-800 text-indigo-800 dark:bg-[#383838] dark:text-[#E1E1FF]" to="/"><IoLogoGithub className="dark:text-[#BAB2E7]"/> Github</Link>
                    <Link  className="flex items-center gap-2  xl:px-5 xl:py-2 px-2 py-1 rounded border  border-indigo-800 text-indigo-800 dark:bg-[#383838] dark:text-[#E1E1FF]" to="/"><FaLinkedinIn className="dark:text-[#BAB2E7]"/> Linkedin</Link>
                </div>
                </div>
                <div className="hero_image_card w-full h-full relative ">
                {image && (
                <img className="hero_image xl:w-[476px] xl:h-[375px] lg:w-[426px] lg:h-[335px] md:lg:w-[426px] md:h-[335px] display-none object-cover rounded-[18px] absolute right-0" src={`${image}`} alt="" />
                )}
            </div>
            </div>
        </div>
