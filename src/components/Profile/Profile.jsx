  ...
  useEffect(() => {
    ...
    return (
      <div className="xl:mt-10 xl:mb-20 lg:mt-5 lg:mb-10 mt-2 mb-5">
         {aboutMe && (
        <h2 className="xl:text-[48px] lg:text-[40px] md:text-[32px] text-[24px] font-bold xl:mb-10 lg:mb-6 md:mb-4 mb-2 dark:text-[#AEBCCF]">{aboutMe.oneTitle}</h2>
        )}
      <div className="profile-section2 xl:flex lg:flex md:flex flex-none xl:gap-4 md:gap-2 gap-1 w-full xl:mb-5 lg:mb-3 mb-2   justify-between">
          ...
          {aboutMe && (
            <h3 className="flex xl:text-[30px] lg:text-[26px] md:text-[20px] text-[16px] text-[#4338CA] dark:text-[#B7AAFF] xl:mb-5  md:mb-3  mb-1">{aboutMe.oneTitle}</h3>
            )}
          ...
          {aboutMe && (
            <h3 className="xl:text-[30px] lg:text-[26px] md:text-[20px] text-[16px] text-[#4338CA] dark:text-[#B7AAFF]">{aboutMe.title}</h3>
            )}
            {aboutMe && (
              <>
